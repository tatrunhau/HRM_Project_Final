// app/admin/state-documents/DocumentModals.tsx
        ...
        <DialogContent className="sm:max-w-md overflow-hidden">
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold bg-gradient-to-r from-gray-500 to-gray-700 text-white px-3 py-2 -m-6 mb-4 rounded-t-lg">
              File Văn bản Nhà nước
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              <label className="text-sm block mb-1 font-medium">File Văn bản *</label>
      ...
      <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader className="flex flex-col items-center justify-center">
             ...
             <DialogTitle className="text-lg font-semibold text-center">Xác nhận xóa văn bản?</DialogTitle>
      ...
      <Dialog open={showSaveModal} onOpenChange={setShowSaveModal}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader className="flex flex-col items-center justify-center">
            ...
            <DialogTitle className="text-lg font-semibold text-center">Xác nhận lưu văn bản?</DialogTitle>
            <DialogDescription className="text-center text-gray-500">
               Dữ liệu văn bản sẽ được cập nhật vào hệ thống.
            </DialogDescription>
          </DialogHeader>
          <div className="flex justify-center gap-3 mt-4">
