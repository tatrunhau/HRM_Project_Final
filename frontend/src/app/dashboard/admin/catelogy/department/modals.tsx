...
import {
  faCircleExclamation, faCircleCheck, faFloppyDisk, faBuilding
          ...
          <DialogHeader className="border-b pb-4 mb-4">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <DialogDescription>Quản lý các phòng ban trong công ty.</DialogDescription>
                </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Mã phòng ban <span className="text-red-500">*</span></label>
                    <Input 
                        value={formData.departmentcode || ''} 
                        onChange={(e) => handleInputChange('departmentcode', e.target.value)} 
                        placeholder="VD: PNS, IT..." 
                        disabled={isEditing}
                        className={isEditing ? "bg-slate-100" : ""}
                    />
                </div>
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Tên phòng ban <span className="text-red-500">*</span></label>
                    <Input 
                        value={formData.name || ''} 
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">Số lượng nhân viên</label>
                    <Input 
                        type="number" 
            ...
            <div className="space-y-2">
                ...
                <textarea 
                    ...
                    placeholder="Mô tả chức năng, nhiệm vụ chính..." 
                />
            </div>
             {/* Hàng 4: Ghi chú */}
            <div className="space-y-2">
                ...
                <textarea 
                    className="flex min-h-[60px] w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
